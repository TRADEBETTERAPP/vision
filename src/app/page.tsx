...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* on root load. The hero/brand band is integrated at the top of   */}
      {/* the atlas, not as a separate section below.                     */}
      {/* ---------------------------------------------------------------- */}
      <Section id="atlas" divider="none" container="wide" spacing="hero">
        <div>
          {/* -------------------------------------------------------------- */}
          {/* Integrated Hero / Brand Band                                    */}
          {/* VAL-NARR-001, VAL-NARR-002, VAL-NARR-011, VAL-NARR-012,       */}
          {/* VAL-VISUAL-000–004, VAL-VISUAL-026                             */}
          {/* Single hero/brand surface at the top of the graph workspace.   */}
          {/* The BETTER logotype is the dominant brand signal; live/future   */}
          {/* status and CTAs are compactly integrated.                       */}
          {/* -------------------------------------------------------------- */}
          <section
            id="what-is-better"
