...
export const GRAPH_NODES: GraphNode[] = [
  {
    ...
    icon: "◆",
    dominantStatus: "live",
    related: ["proof", "live-now", "macro-thesis"],
    category: "identity",
  ...
  },
  {
    ...
    icon: "✓",
    dominantStatus: "live",
    related: ["what-is-better", "live-now", "roadmap", "hft-edge"],
    category: "proof",
  ...
  },
  {
    ...
    icon: "⬡",
    dominantStatus: "in_progress",
    related: ["roadmap", "tokenomics", "evidence", "hft-edge", "llm-product"],
    category: "analysis",
  ...
  },
  {
    ...
    icon: "⬢",
    dominantStatus: "in_progress",
    related: ["architecture", "proof", "truth-perp-flywheel"],
    category: "analysis",
