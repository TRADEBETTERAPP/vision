 ...
 * for the first vault — individual allocations within
...
export const FIRST_VAULT_POLICY: FirstVaultPolicy = {
  ...
  source: {
    ...
    label: "BETTER Docs",
    note:
      "Q1 2026 first-vault rules: 100,000 BETTER universal minimum for all quant-team vaults, $25,000 total vault deposit cap across all qualifying stakers. Individual allocations determined by the √-weighted bidding model with a per-staker cap and $100 USDC floor.",
    asOf: "2026-Q1",
  },
};
...
export const REFERRAL_INCENTIVE_POLICY: ReferralIncentivePolicy = {
  ...
  payoutCapPerReferrer:
    "$10,000 cumulative referral earnings per referrer, reviewed quarterly. Exceeding the cap requires manual review.",
